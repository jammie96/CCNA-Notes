...
> Router has chosen EIGRP as it has administrative distance of 90
...
- Because each entry in a routing table may specify a subnetwork, a packet's destination may match more than one routing table entry
	- E.g. a packet destined to 10.10.2.3 would match 10.0.0.0/8, 10.10.0.0/16 and 10.10.2.0/24
